...
void draw(Object obj) {
  ...
  glm::mat4 model0 = glm::rotate(glm::mat4(1.0f), (float)time * 5, glm::vec3(1.0f, 1.0f, 1.0f));
  model0 = glm::scale(model0, glm::vec3(0.7f, 0.2f, 0.2f));
  glUniformMatrix4fv(modelLocation, 1, GL_FALSE, &model0[0][0]);
  glDrawArrays(GL_TRIANGLES, 0, obj.count);
  
  glm::mat4 model1 = glm::translate(glm::mat4(1.0f), glm::vec3(-2.0f, 1.0f, 0.0f));
  model1 = glm::rotate(model1, (float)time, glm::vec3(1.0f, 1.0f, 0.0f));
  ...
  model2 = glm::rotate(model2, (float)time, glm::vec3(1.0f, 1.0f, 1.0f));
  model2 = glm::scale(model2, glm::vec3(0.4f, 0.4f, 0.4f));
  glUniformMatrix4fv(modelLocation, 1, GL_FALSE, &model2[0][0]);
  glDrawArrays(GL_TRIANGLES, 0, obj.count);
}
